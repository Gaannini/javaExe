...
public class Restaurant {
	...
	/*
	 * 생성자 함수(메서드) 1) 클래스 이름과 동일 2) return형이 없다 3) 객체 생성되면 자동으로 가장 먼저 호출된다. 4) 객체의자동
	 * 초기화 작업 5) 필드변수의 초기화 작업
	 */
	// this는 객체 자신을 의미하며 객체 자신의 필드를 가리킬 때 사용한다.
	...
	public void deliveryFood() {
		...
		System.out.println(food + "가 나왔습니다.");
