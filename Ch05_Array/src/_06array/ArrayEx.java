...
public class ArrayEx {
	public static void main(String[] args) {
		...
		System.out.println(scores); // [I@4fb64261
		System.out.println(scores1); // [I@4fb64261
		System.out.println(scores2); // [I@4fb64261
		System.out.println();
		...
		scores[2] = 11111111;
		System.out.println(Arrays.toString(scores)); // [100, 88, 11111111, 67, 75]
		System.out.println(Arrays.toString(scores1)); // [100, 88, 11111111, 67, 75]
		System.out.println(Arrays.toString(scores2)); // [100, 88, 11111111, 67, 75]
		System.out.println(Arrays.toString(scores4)); // [100, 88, 99999, 67, 75]
	}
}